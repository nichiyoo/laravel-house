...
<div x-data="modal" x-trap.inert.noscroll="show" x-on:open-modal.window="open" x-on:close-modal.window="close"
  x-on:keydown.escape.window="show = false" x-show="show" class="fixed inset-0 z-50 grid items-end">
  ...
  <div x-cloak class="rounded-t-3xl w-full transform transition-transform max-w-lg mx-auto bg-base-50" x-show="show"
